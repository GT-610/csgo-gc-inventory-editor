...
online-mode-modal-api-info = Online metadata fetches accurate and detailed item data from a third-party API. Your data will not be uploaded.
online-mode-modal-internet = Online metadata requires a valid internet connection for the first time or manual updates.
