...
game-data-error-title = Game Data Files Missing
game-data-error-help = Some required game data files were not found. Please ensure the csgo directory with items_game.txt and language files is placed next to the executable.
